#ifndef __GROVE_SIMPLE_MOISTURE_AUSEX_H__
#define __GROVE_SIMPLE_MOISTURE_AUSEX_H__

#define _TEMPLATE_CLASS GroveSimpleMoistureAusEx
#define _SENSOR_NAME "GroveSimpleMoistureAusEx"
...
#endif /* __GROVE_SIMPLE_MOISTURE_AUSEX_H__ */
