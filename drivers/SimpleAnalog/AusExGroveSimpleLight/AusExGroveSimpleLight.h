#ifndef __GROVE_SIMPLE_LIGHT_AUSEX_H__
#define __GROVE_SIMPLE_LIGHT_AUSEX_H__

#define _TEMPLATE_CLASS GroveSimpleLightAusEx
#define _SENSOR_NAME "GroveSimpleLightAusEx"
...
#endif /* __GROVE_SIMPLE_LIGHT_AUSEX_H__ */
