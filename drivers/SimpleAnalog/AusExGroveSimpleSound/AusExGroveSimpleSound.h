#ifndef __GROVE_SIMPLE_SOUND_AUSEX_H__
#define __GROVE_SIMPLE_SOUND_AUSEX_H__

#define _TEMPLATE_CLASS GroveSimpleSoundAusEx
#define _SENSOR_NAME "GroveSimpleSoundAusEx"
...
#endif /* __GROVE_SIMPLE_SOUND_AUSEX_H__ */
