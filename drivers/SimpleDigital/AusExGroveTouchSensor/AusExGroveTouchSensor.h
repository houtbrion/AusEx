#ifndef __GROVE_TOUCH_SENSOR_AUSEX_H__
#define __GROVE_TOUCH_SENSOR_AUSEX_H__

#define _TEMPLATE_CLASS GroveTouchSensorAusEx
#define _SENSOR_NAME "GroveTouchSensorAusEx"
...
#endif /* __GROVE_TOUCH_SENSOR_AUSEX_H__ */
