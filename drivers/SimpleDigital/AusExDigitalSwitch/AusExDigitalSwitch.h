#ifndef __GROVE_DIGITAL_SWITCH_AUSEX_H__
#define __GROVE_DIGITAL_SWITCH_AUSEX_H__

#define _TEMPLATE_CLASS GroveDigitalSwitchAusEx
#define _SENSOR_NAME "GroveSwitch"
...
#endif /* __GROVE_DIGITAL_SWITCH_AUSEX_H__ */
