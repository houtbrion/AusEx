# AusEx library for DHT series sensor
このライブラリは，
seeed studioのGroveシステムのいろいろなセンサ類のライブラリを
Adafruitのセンサ統合ライブラリと同じAPIに修正してみるプロジェクトの一部で
DHTシリーズの温度・湿度センサ用ドライバです．

Groveの場合，[Grove - Temperature&Humidity Sensor][SeedWiki]や[Grove - Temperature&Humidity Sensor Pro][seedwiki2]が
それに相当しますが，搭載しているセンサモジュールはDHT11とDHT22/AM2302となります．

このドライバのベースとなるソフトウェアは，Adafruitの[DHT-sensor-library][github]となっています．

## ライセンスについて
ベースとなる[Adafruitのソフトウェア][github]にはライセンスが明示されていませんが，ソースの中には
 "AS IS"の記述があるものと，"MIT"のものが混ざっており，よくわからない状況です．

 とりあえず，元のソースに従うとだけしておきます．

なんで，「1つのドライバで違うライセンスをまぜるかなぁ」と思ってしまいます．
...
[SeedWiki]:http://wiki.seeedstudio.com/Grove-TemperatureAndHumidity_Sensor/
[SeedWiki2]:http://wiki.seeedstudio.com/Grove-Temperature_and_Humidity_Sensor_Pro/
