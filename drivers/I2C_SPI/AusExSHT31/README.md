# AusEx library for SHT31 sensor
このライブラリは，
いろいろなセンサ類のライブラリを
Adafruitのセンサ統合ライブラリと同じAPIに修正してみるプロジェクトの一部で
SHT31温度・湿度センサ用ドライバです．

## ライセンスについて
ベースとなる[Adafruitのソフトウェア][github]はソースの先頭にBSDライセンスと
記載されているので，それを踏襲します．
...
## 外部リンク
- ソースリポジトリ [https://github.com/adafruit/Adafruit_SHT31][github]
