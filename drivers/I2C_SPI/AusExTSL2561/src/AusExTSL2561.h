#ifndef __AUSEX_TSL2561_H__
#define __AUSEX_TSL2561_H__
...
#define AUSEX_TSL2561_CLASS AusExTSL2561
#define AUSEX_TSL2561_LIGHT_SENSOR_NAME "AusExTSL2561"
#define AUSEX_TSL2561_LIGHT_SENSOR_TYPE SENSOR_TYPE_LIGHT
#define AUSEX_TSL2561_LIGHT_SENSOR_LIBRARY_VERSION 1
#define AUSEX_TSL2561_LIGHT_SENSOR_RETURN_VALUE light
#define AUSEX_TSL2561_LIGHT_SENSOR_VALUE_TYPE float
#define AUSEX_TSL2561_LIGHT_SENSOR_MIN_VALUE 1.0
#define AUSEX_TSL2561_LIGHT_SENSOR_MAX_VALUE 17000.0
#define AUSEX_TSL2561_LIGHT_SENSOR_RESOLUTION 1.0
#define AUSEX_TSL2561_LIGHT_SENSOR_MIN_DELAY 0
#define AUSEX_TSL2561_LIGHT_SENSOR_INIT_DELAY 0

#define AUSEX_TSL2561_LIGHT_SENSOR_DEFAULT_I2C_ADDR TSL2561_ADDR_LOW
...
class AUSEX_TSL2561_CLASS : public Adafruit_SensorEx {
public:
  AUSEX_TSL2561_CLASS(TwoWire *theWire, int32_t sensorID = -1);
  bool begin(uint32_t addr=AUSEX_TSL2561_LIGHT_SENSOR_DEFAULT_I2C_ADDR);
  bool getEvent(sensors_event_t*);
  void getSensor(sensor_t*);
  bool enableAutoRange(bool enabled);
  int setMode(int mode);
  int getMode();
  int generateMode(tsl2561Gain_t gain , tsl2561IntegrationTime_t itime);
  bool parseMode(int mode, tsl2561Gain_t *gain , tsl2561IntegrationTime_t *itime);
...
private:
  ...
  AUSEX_TSL2561_LIGHT_SENSOR_VALUE_TYPE calculateLux(uint16_t broadband, uint16_t ir);

};



#endif /* __AUSEX_TSL2561_H__ */
