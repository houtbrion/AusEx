#ifndef __AUSEX_TCS34725_H__
#define __AUSEX_TCS34725_H__
...
#define AUSEX_TCS34725_CLASS AusExTCS34725
#define AUSEX_TCS34725_SENSOR_NAME "TCS34725"
#define AUSEX_TCS34725_SENSOR_TYPE SENSOR_TYPE_COLOR
#define AUSEX_TCS34725_SENSOR_LIBRARY_VERSION 1
#define AUSEX_TCS34725_SENSOR_RETURN_VALUE color
#define AUSEX_TCS34725_SENSOR_VALUE_TYPE sensors_color_t
#define AUSEX_TCS34725_SENSOR_MIN_VALUE 0
#define AUSEX_TCS34725_SENSOR_MAX_VALUE 1
#define AUSEX_TCS34725_SENSOR_RESOLUTION 1
#define AUSEX_TCS34725_SENSOR_MIN_DELAY 0
#define AUSEX_TCS34725_SENSOR_INIT_DELAY 0

#define AUSEX_TCS34725_SENSOR_DEFAULT_I2C_ADDR TCS34725_ADDRESS



class AUSEX_TCS34725_CLASS : public Adafruit_SensorEx {
public:
  AUSEX_TCS34725_CLASS(TwoWire *theWire, int32_t sensorID = -1);
  bool begin(uint32_t addr=AUSEX_TCS34725_SENSOR_DEFAULT_I2C_ADDR);
  float calculateColorTemperature(void);
  float calculateLux(void);
  float calculateColorTemperature_dn40(void);
  bool getEvent(sensors_event_t*);
  void getSensor(sensor_t*);
  bool enableAutoRange(bool enabled);
  int setMode(int mode);
  int getMode();
  int generateMode(tcs34725Gain_t gain , tcs34725IntegrationTime_t itime);
  bool parseMode(int mode, tcs34725Gain_t *gain , tcs34725IntegrationTime_t *itime);
