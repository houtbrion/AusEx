#ifndef __GROVE_FLAME_SENSOR_AUSEX_H__
#define __GROVE_FLAME_SENSOR_AUSEX_H__

#define _TEMPLATE_CLASS GroveFlameSensorAusEx
#define _SENSOR_NAME "GroveFlameSensorAusEx"
...
#endif /* __GROVE_FLAME_SENSOR_AUSEX_H__ */
