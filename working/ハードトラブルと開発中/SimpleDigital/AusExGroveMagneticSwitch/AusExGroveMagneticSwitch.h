#ifndef __GROVE_MAGNETIC_SWITCH_AUSEX_H__
#define __GROVE_MAGNETIC_SWITCH_AUSEX_H__

#define _TEMPLATE_CLASS GroveMagneticSwitchAusEx
#define _SENSOR_NAME "GroveMagneticSwitchAusEx"
...
public:
  _TEMPLATE_CLASS(int pinNumber, uint32_t sensorID = -1);
  _TEMPLATE_CLASS(int pinNumber,bool pullUp, uint32_t sensorID = -1);
  bool begin(void);
...
#endif /* __GROVE_MAGNETIC_SWITCH_AUSEX_H__ */
