...
typedef enum
{
    ...
    SENSOR_TYPE_LINEAR_ACCELERATION   = (9),  /**< Acceleration not including gravity */
    SENSOR_TYPE_ROTATION_VECTOR       = (10),
    SENSOR_TYPE_RELATIVE_HUMIDITY     = (11),
    SENSOR_TYPE_AMBIENT_TEMPERATURE   = (12),
    SENSOR_TYPE_VOLTAGE               = (13),
    SENSOR_TYPE_CURRENT               = (14),
    SENSOR_TYPE_COLOR                 = (15),
    SENSOR_TYPE_SIMPLE                = (16),
    SENSOR_TYPE_ANGLE                 = (17),
    SENSOR_TYPE_1AXIS_GYRO            = (18),
    SENSOR_TYPE_DISTANCE              = (19),
    SENSOR_TYPE_LARGE_INT             = (20),
    SENSOR_TYPE_DUST                  = (21),
    SENSOR_TYPE_IRREMOTE              = (22),
    SENSOR_TYPE_POSITION              = (23),
    SENSOR_TYPE_DATE                  = (24),
    SENSOR_TYPE_SPEED_KNOT            = (25),
    SENSOR_TYPE_SIMPLE_ANALOG         = (26)
} sensors_type_t;
